...
| 프리셋 | `p` | 느낌 |
|--------|----:|------|
| **크게** · *Loud* | 0.3 | 같은 슬라이더 위치에서 가장 크게 — 초반부터 큼 (≈ 유튜브의 진폭 선형 느낌) |
...
- 🎚️ **조절 가능한 청감 곡선** — *크게 / Loud (0.3)*부터 *고름 / Even (0.4, 추천 — 체감 음량이 슬라이더를 그대로 따라감)*을 거쳐 *스포티파이 디폴트 / Spotify default (1.0)*까지 프리셋 + **실시간 곡선 그래프**.
